...
templateImageTextController.$inject = ["textAngularManager","contentSrv","commonImageSrv","$state","$stateParams"];

angular.module("publisher").controller("templateImageTextController",templateImageTextController);